  ...
  return (
    ...
    <div className='flex flex-row flex-wrap justify-stretch align-items-center'>
        {(products.length) ? products.map(item => (
            <div className='w-full sm:w-1/2 md:w-1/2 lg:w-1/3 xl: xl:w-1/3 bg-slate-300 rounded-md m-4 p-4 text-center hover:bg-slate-400 hover:text-gray-100 product-item shadow-2xl' key={item.id}>                
                ...
                <div className="action flex flex-row flex-wrap align-bottom align-items-end justify-between">
                    <button className=' bg-neutral-600 text-zinc-100 py-1 px-2 text-sm rounded-md hover:bg-neutral-100 hover:text-zinc-900' ><FaCartArrowDown className='w-8 text-xl m-auto text-center' /></button>
                    <button className=' bg-neutral-600 text-zinc-100 py-1 px-2 text-sm rounded-md hover:bg-neutral-100 hover:text-zinc-900' ><FaHeartCircleCheck className='w-8 text-xl m-auto text-center' /></button>
                </div>                
            </div>
        )) : 'No products'}
    </div>
